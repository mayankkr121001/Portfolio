...
function Contact() {
    return (
        <div id='Contact' className='w-full font-nunito'>
            <div className='text-center'>
                ...
                <div className='bg-[#fff000] text-black px-[5%] lg:px-[8%] pt-[50px]'>
                    <div className='flex flex-col gap-[50px] sm:flex-row sm:gap-[8%] md:gap-[15%] mbTb:justify-between'>
                        <div className='text-left w-[90%] sm:w-[40%]'>
                            ...
                            <div>
                                <a href='https://www.linkedin.com/in/mayank-kumar-a4452b1ba/' target='_blank' className='aboutSocialIconsDiv bg-white rounded-full inline-block p-2 w-10 mr-4'>
                                    <img className="aboutSocialIcons w-8" src={linkedinIcon} alt="linkedin" />
                                </a>
                                <a href='https://github.com/mayankkr121001' target='_blank' className='aboutSocialIconsDiv bg-white rounded-full inline-block p-2 w-10 mr-4'>
                                    <img className="aboutSocialIcons w-8" src={githubIcon} alt="github" />
                                </a>
                                <a href='mailto:mayanksahu121001@gmail.com' target='_blank' className='aboutSocialIconsDiv bg-white rounded-full inline-block p-2 w-10 mr-4'>
                    ...
                    <div className='mt-8 pb-3'>
                        ...
                        <p>Designed by  <span className='font-bold'>&#123; Mayank &#125;</span></p>
                    </div>
                </div>
